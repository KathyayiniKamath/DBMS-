...
<header>
	<div class="header">
	 <a href="#default" class="logo"><img style="height: 80px;" src="logo.png" alt="logo"></a>
	 <br>
	  <div class="header-right">
		
	    <div class="subnav">
		   <button class="subnavbtn">Login/SignUp<i class="#"></i></button>
		   <div class="subnav-content">
		   <li><a  href="auth/FarmerLogin.php">Farmer</a></li>
		   <li><a  href="auth/BuyerLogin.php">Buyer</a></li>
		...
		<ul>
			...
			<li data-transition="parallaxvertical" data-ease="SlowMo.ease">
				...
				<div class="tp-caption sfb tp-resizeme caption-p" 
			        ...
			        data-transform_out="o:0" 
			        data-start="1000">
					"AgriWiseHub- <strong>You Need for Agronomy</strong>."
			    </div>
...
<section class="about-info-box sec-padding" style="background-color: white;">
	<div class="thm-container">
		<div class="row">
		
			
			<div class="col-lg-8 col-md-8" style="color:black">
				<div class="sec-title"style="color:black">
					<h2><span>What is AgriWiseHub</span></h2>
					<ul class="bulleted-list">
					<li><i class="fa fa-arrow-circle-right"></i>AgriWiseHub is a platform that connects farmers and agricultural experts to share knowledge and resources.</li> 
					</ul>
					<h2><span>What does AgriWiseHub means?</span></h2>
					<ul class="bulleted-list">
						<li><i class="fa fa-arrow-circle-right"></i> AgriWiseHub - A network connecting individuals and organizations involved in agriculture.</li>
						<li><i class="fa fa-arrow-circle-right"></i> AgriWiseHub also stands for One stop shop for Indian farmers, growing knowledge, growing crops.</li>
					</ul>
					<h2><span>Reasons to Use AgriWiseHub</span></h2>
					<ul class="bulleted-list"> 
					<li><i class="fa fa-arrow-circle-right"></i>From weather to markets, AgriculturewiseHub is the ultimate tool for Indian farmers.</li>
					<li><i class="fa fa-arrow-circle-right"></i>Grow smarter, not harder: AgriculturewiseHub empowers Indian farmers with all the info they need.</li>
					<li><i class="fa fa-arrow-circle-right"></i>It offers weather forecasts, government initiatives, seed pricing, and easy transactions for buying and selling farm products.</li> 
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 footer-widget">
				<div class="about-widget">
					<a href="index.html"><img style="height: 150px;" src="logo.png" alt="logo"/></a>
...
<section class="bottom-bar">
	<div class="thm-container clearfix">
		<div class="pull-left">
			<p>AgriWiseHub All rights reserved.</p>
		</div>
		<div class="pull-right">
			
			<a href="#">Created By : <i>AgriWiseHub</i> </a>
