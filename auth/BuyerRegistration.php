...
<head>
    ...
    * {
    ...
    body{
		...
		width:100%;
        background-image: url("./buyerregis.jpg");
	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card" style="background-color:rgba(255, 255, 255, 0.498)">
					<div class="card-header" style="background-color:green"><h4 style="font-style:bold;color:white">Register</h4></div>
