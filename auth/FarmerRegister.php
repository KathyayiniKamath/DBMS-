...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card" style="background-color: rgba(255, 255, 255, 0.395)">
						<div class="card-header" style="background-color:green"><h4 style="font-style:bold;color:white">Farmer Registration<h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary " style="background-color:green;color:white"   name="register" value="Register">
										Register
									</button>
								</div>
							</form>
...
if (isset($_POST['register'])) {
    ...
    // Other validations and processing here
    ...
    $query = "insert into farmerregistration (farmer_name, farmer_phone, farmer_address, farmer_state, farmer_district, farmer_pan, farmer_bank, farmer_password) 
              VALUES ('$name', '$phonenumber', '$address', '$state', '$district', '$pan', '$account', '$encrypted_password')";
