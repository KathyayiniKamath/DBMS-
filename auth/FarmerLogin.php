	...
	<style>
		...
		* {
		...
		body {
			...
			background-image: url("./farmerlogin.png");
...
<body>
	...
	<main class="my-form" style="width:70%;margin-top:100px;margin-left:200px">
		<div class="cotainer" >
			<div class="row justify-content-center" >
				<div class="col-md-8">
					<div class="card " style="background-color:rgba(255, 255, 255, 0.436)" >
						<div class="card-header text-left" style="background-color:green">
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary text-left border border-dark" style="background-color:green;color:white;border-radius:30%" name="login" value="Login">
										Login
									</button>
								</div>
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"  class="text-left"><a id='link'  href="FarmerForgotPassword.php"><b style="color:white ;text-align:left"> Forgot your password </b></a></label>
									<br>
									<label id="account" class="text-left"><a id='link' href="FarmerRegister.php"><b style="color:white"> Create New Account</b></a></label>
								</div>
							</form>
						</div>
					</div>
